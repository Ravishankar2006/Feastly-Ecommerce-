    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-purple-600 to-purple-800 flex items-center justify-center px-6 py-12">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">Join Feastly!</h1>
          <p className="text-blue-100">Create your account and start ordering</p>
        </div>
        ...
        <div className="bg-white bg-opacity-10 backdrop-blur-lg rounded-2xl p-8 shadow-2xl border border-white border-opacity-20">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-start">
              ...
              <label className="ml-2 text-sm text-white">
                I agree to the{' '}
                <Link to="/terms" className="text-blue-200 hover:text-white underline">
                  Terms of Service
                </Link>
                {' '}and{' '}
                <Link to="/privacy" className="text-blue-200 hover:text-white underline">
                  Privacy Policy
                </Link>
              </label>
            </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button className="btn-secondary flex items-center justify-center space-x-2 bg-white bg-opacity-10 text-white border-white border-opacity-30 hover:bg-opacity-20">
          ...
          <div className="mt-8 text-center">
            <p className="text-white">
              ...
              <Link to="/login" className="text-blue-200 hover:text-white font-semibold transition-colors duration-200">
                Sign in here
              </Link>
            </p>
          </div>
